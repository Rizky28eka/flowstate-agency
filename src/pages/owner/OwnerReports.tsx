...
import { FileText, Download, Calendar, BarChart3, DollarSign, Users, Plus, Loader2, AlertCircle } from "lucide-react";
            ...
            {isLoading ? (
              ...
              <div className="text-center text-red-500 p-6">
                <div className="flex items-center justify-center gap-2">
                  <AlertCircle className="h-4 w-4" /> Error fetching reports.
                </div>
              </div>
            ) : reports.length === 0 ? (
